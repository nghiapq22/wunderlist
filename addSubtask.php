<?php
    ...
    // echo $taskId;
    $sql = "INSERT into subtask(title, taskid) VALUES ('$subTask', '$taskId')" ;
    $stmt = $db->prepare($sql);
    $stmt->execute();
    ...
    echo '
        <li>
            ...
            <input name="subTaskName" class="subTaskName" type="text" value="'.$subTask.'"> <span>'.$subTaskId.'</span>
