...
<div id="right-mouse">
        <ul class="inbox">
            <div class="list-item">
                <li>
                    <div class="icon">
                        <svg class="email" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                    <div class="icon">
                        <svg class="print" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink">
                            <g stroke="none" stroke-width="1" fill-rule="evenodd">
                                <g>
        ...
        <ul class="cong-viec">
            <div class="list-item">
                <li>
                    <div class="icon">
                        <svg class="folders rtl-flip" width="20px" height="20px" viewBox="0 0 20 20" version="1.1"
            ...
            <div class="list-item">
                <li>
                    <div class="icon">
                        <svg class="options rtl-flip" width="20px" height="20px" viewBox="0 0 20 20" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <g stroke="none" stroke-width="1" fill-rule="evenodd">
                                <g id="options">
            ...
            <div class="list-item end">
                ...
                <li class = 'delete-list'>
                    <div class="icon">
                        <svg class="trash" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink">
                            <g stroke="none" stroke-width="1" fill-rule="evenodd">
                                <g id="trash">
        ...
        <ul class="task-top">
            <div class="list-item">
                <li>
                    <div class="icon">
                        <svg class="completed" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink">
                            <g stroke="none" stroke-width="1" fill-rule="evenodd">
                                <g id="completed">
                ...
                <li>
                    <div class="icon">
                        <svg class="star" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink">
                            <g stroke="none" stroke-width="1" fill-rule="evenodd">
                                <g id="star">
            ...
            <div class="list-item">
                <li>
                    <div class="icon">
                        <svg class="today" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink">
                            <g stroke="none" stroke-width="1" fill-rule="evenodd">
                                <g id="today">
            ...
            <div class="list-item">
                <li>
                    <div class="icon">
                        <svg class="plus-small" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="text">
                        Create a new list from To-do
                    </div>
                </li>
                <li id="special">
                    <div class="icon special">
                        <svg class="move" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <div class="chevron">
                        <svg class="folder-arrow" width="15px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink">
                            <g stroke="none" stroke-width="1" fill-rule="evenodd">
                                <g id="folder-arrow">
    ...
    <div class="modal">
        <div class="dialog-wrapper">
            <div class="content">
                <div id="style-1" class="tab">
                    <ul>
                        <li>
                            <a href="#">
                                <span class="icon genaral">

                                </span>
                                <span class="text">Genaral</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                        ...
                        <li>
                            <a href="#">
                                <span class="icon small-list">

                                </span>
                                <span class="text">Small List</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <span class="icon notificaltions">

                                </span>
                                <span class="text">Notificaltions</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                ...
                <!--genaral-->
                <div id="style-1" class="setting-content genaral">
                    <!--language-->
                    <div class="rows">
                        <div class="col-60">
                        ...
                        <div class="col-40">
                            <select class="language" name="language" id="language">
                                ...
                                <option value="english">Portugal</option>
                            </select>
                        </div>
                    </div>
                    <!--date format-->
                    ...
                    <div class="rows">
                        ...
                        <div class="col-40">
                            <input type="radio" name="time" id="radio" checked><span>12 Horus</span>
                            <input type="radio" name="time" id="radio"><span>24 Hours</span>
                        </div>
                    </div>
                    <!--language-->
                    <div class="rows">
                        <div class="col-60">
                            <label for="day">Star of the week</label>
                        </div>
                        <div class="col-40">
                            <select class="day" name="day" id="day">
                                <option value="saturday">Saturday</option>
                                <option value="sunday">Sanday</option>
                ...
                <!--acccount-->
                <div id="style-1" class="setting-content account">
                    <div class="avatar">
                    ...
                    <div class="account-setting">
                        ...
                        <div class="rows">
                            ...
                            <div class="col-68">
                                <input type="text" value="Quang Nghia">
                            </div>
                        </div>
                        <!--email-->
                        <div class="rows">
                            ...
                            <div class="col-40">
                                <input type="text" value="nghiapq22@gmail.com" disabled>
                            </div>
                            <div class="col-28">
                        ...
                        <div id="row-3" class="rows">
                            ...
                            <div class="col-68">
                                <a href="#">Add or manage your email addresses</a>
                            </div>
                        </div>
                        <!--password-->
                        <div class="rows">
        ...
        <!--create new list-->
            <div class="create-newlist">
                <div class="content-header">
                    <h3 class = "create">Create New List</h3>
                 
                    <div class="separator nolive">
                        <input class = 'listname' name='listname' type="text" placeholder="List Name">
                    </div>
                    <div class="separator nolive">
                    ...
                    <div class="separator nolive tab member">
                        <span class="icon">
                            <svg class="share rtl-flip" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g stroke="none" stroke-width="1" fill-rule="evenodd">
                        ...
                        <span class="input"><input type="text" placeholder="Name or email address"></span>
                    </div>
                        ...
                        <li>
                            ...
                            <div class="content-people-meta">
                                <div class="content-people-name">
                                    <span class="name">Quang Nghia</span>
                                    <span class="badge">Owner</span>
                                </div>
                                <div class="content-people-email">
                                    nghiapq22@gmgmail.com
                                </div>
                            </div>
                        </li>
                    </ul>
        ...
        <!--Edit new list-->
            ...
            <div class="edit-list">
                <div class="content-header">
                    <h3 class = "create">Edit List</h3>
                 
                    <div class="separator nolive">
                        <input class='listname' name='listname' type="text" placeholder="List Name" value="<?php
                                $listId = $_GET['listId'];
        ...
        <div class="delete-item">
            <div class="content">
                ...
                <div class="content-footer">
                    ...
                    <button class="delete">Delete To-do</button>
    ...
    <div id="main-left">
        <div id="top-left">
            <div style="cursor: pointer" id="menu">
                <svg class="list-toggle" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve">
                    <g>
            ...
            <div id="search">
                <svg style="cursor: pointer;fill:aliceblue" class="search rtl-flip" width="20px" height="20px" viewBox="0 0 20 20"
            ...
            <div id="user">
                <div class="menu-user">
                    <div class="content">
                        <ul class="list">
                            <li><a href="#">
                                    <div id="text-1" class="text">Last synced a few seconds ago</div>
                                </a></li>
                            <li id="li-2" class="li-1"><a href="#">
                                    <div class="text">Syns Now</div>
                                </a></li>
                            <li id="li-2"><a href="#">
                                    <div class="text">Acount Setting</div>
                                </a></li>
                            <li id="li-2"><a href="#">
                                    <div class="text">Change Background</div>
                                </a></li>
                            <li id="li-2" class="li-1"><a href="#">
                                    <div class="text">Restore delete list</div>
                                </a></li>
                            <li id="li-2"><a href="#">
                                    <div class="text">Install the Browser Entension</div>
                                </a></li>
                            <li id="li-2"><a href="#">
                                    <div class="text">Love Wunderlist?</div>
                                </a></li>
                            <li id="li-2"><a href="#">
                                    <div class="text">Tell your friend...</div>
                                </a></li>
                            <li id="li-2" class="li-1"><a href="#">
                                    <div class="text">Wunderlist website</div>
                                </a></li>
                            <li><a href="#">
                                    <div id="text-1" class="text">nghiapq22@gmail.com</div>
                                </a></li>
                            <li id="li-2"><a href="logout.php">
                ...
                <span id="user-name"><?php echo  $_SESSION['email']  ?></span>
                <span id="user-arrow">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20px"
                        height="20px" viewBox="0 0 20 20" version="1.1" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
                        <g>
                            <path d="M10.502,13c-0.132,0 -0.26,-0.053 -0.354,-0.146l-4.002,-4c-0.195,-0.195 -0.195,-0.512 0,-0.708c0.195,-0.195 0.512,-0.195 0.707,0l3.649,3.647l3.644,-3.647c0.195,-0.195 0.512,-0.195 0.707,0c0.195,0.195 0.195,0.512 0,0.708l-3.997,4c-0.094,0.093 -0.221,0.146 -0.354,0.146"></path>
                        </g>
                    </svg>
                </span>
            </div>

            <div id="stream-counts">
        ...
        <div class="lists-scroll" id="style-1">
            <div id="filter-colection">
                <span class="icon">
                    <svg class="inbox" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g stroke="none" stroke-width="1" fill-rule="evenodd">
                            <g>
                                <path d="M10,15 C8.8,15 7.78,14.14 7.56,13 L2.5,13 C2.22,13 2,12.78 2,12.5 L2,3.5 C2,2.68 2.68,2 3.5,2 L16.5,2 C17.32,2 18,2.68 18,3.5 L18,12.5 C18,12.78 17.78,13 17.5,13 L12.44,13 C12.22,14.14 11.2,15 10,15 L10,15 Z M3,12 L8,12 C8.28,12 8.5,12.22 8.5,12.5 C8.5,13.32 9.18,14 10,14 C10.82,14 11.5,13.32 11.5,12.5 C11.5,12.22 11.72,12 12,12 L17,12 L17,3.5 C17,3.22 16.78,3 16.5,3 L3.5,3 C3.22,3 3,3.22 3,3.5 L3,12 Z M5.5,6 C5.22,6 5,5.78 5,5.5 C5,5.22 5.22,5 5.5,5 L14.5,5 C14.78,5 15,5.22 15,5.5 C15,5.78 14.78,6 14.5,6 L5.5,6 Z M5.5,8 C5.22,8 5,7.78 5,7.5 C5,7.22 5.22,7 5.5,7 L14.5,7 C14.78,7 15,7.22 15,7.5 C15,7.78 14.78,8 14.5,8 L5.5,8 Z M5.5,10 C5.22,10 5,9.78 5,9.5 C5,9.22 5.22,9 5.5,9 L14.5,9 C14.78,9 15,9.22 15,9.5 C15,9.78 14.78,10 14.5,10 L5.5,10 Z M3.5,18 C2.68,18 2,17.32 2,16.5 L2,14.5 C2,14.22 2.22,14 2.5,14 C2.78,14 3,14.22 3,14.5 L3,16.5 C3,16.78 3.22,17 3.5,17 L16.5,17 C16.78,17 17,16.78 17,16.5 L17,14.5 C17,14.22 17.22,14 17.5,14 C17.78,14 18,14.22 18,14.5 L18,16.5 C18,17.32 17.32,18 16.5,18 L3.5,18 Z"
                                    id="A"></path>
                            </g>
                        </g>
                    </svg>
    ...
    <div id="main-mid">
        ...
        <div class="top-main">
            ...
            <div class="lists-icon">
                <div class="icon share">
                    <div class="top">
                        <svg class="share rtl-flip" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-disabled="true">
                            <g stroke="none" stroke-width="1" fill-rule="evenodd">
                                <g id="share">
                                    <path d="M11.5025,12 C13.7825,12 15.5025,8.84 15.5025,6 C15.5025,3.8 13.7025,2 11.5025,2 C9.3025,2 7.5025,3.8 7.5025,6 C7.5025,8.5 9.0225,12 11.5025,12 L11.5025,12 Z M11.5025,3 C13.1625,3 14.5025,4.34 14.5025,6 C14.5025,8.26 13.1225,11 11.5025,11 C9.8425,11 8.5025,8.26 8.5025,6 C8.5025,4.34 9.8425,3 11.5025,3 L11.5025,3 Z M4.5025,10 L6.0025,10 C6.2825,10 6.5025,9.78 6.5025,9.5 C6.5025,9.22 6.2825,9 6.0025,9 L4.5025,9 L4.5025,7.5 C4.5025,7.22 4.2825,7 4.0025,7 C3.7225,7 3.5025,7.22 3.5025,7.5 L3.5025,9 L2.0025,9 C1.7225,9 1.5025,9.22 1.5025,9.5 C1.5025,9.78 1.7225,10 2.0025,10 L3.5025,10 L3.5025,11.5 C3.5025,11.78 3.7225,12 4.0025,12 C4.2825,12 4.5025,11.78 4.5025,11.5 L4.5025,10 Z M18.2625,14.88 C18.0625,14 17.4025,13.28 16.5225,13.04 L14.2225,12.36 C14.0825,12.32 13.9625,12.26 13.8625,12.14 C13.6625,11.96 13.3425,11.96 13.1625,12.16 C12.9625,12.34 12.9625,12.66 13.1625,12.86 C13.3825,13.08 13.6425,13.24 13.9425,13.32 L16.2425,14 C16.7625,14.14 17.1625,14.58 17.2825,15.1 L17.4425,15.8 C16.9025,16.16 15.2025,17 11.5025,17 C7.7825,17 6.1025,16.14 5.5625,15.8 L5.7225,15.04 C5.8425,14.5 6.2625,14.06 6.8025,13.92 L9.0425,13.32 C9.3425,13.24 9.6225,13.08 9.8625,12.86 C10.0425,12.66 10.0425,12.34 9.8625,12.14 C9.6625,11.96 9.3425,11.96 9.1425,12.14 C9.0425,12.24 8.9225,12.32 8.7825,12.36 L6.5425,12.96 C5.6425,13.2 4.9625,13.92 4.7425,14.82 L4.5225,15.9 C4.4825,16.06 4.5225,16.24 4.6425,16.36 C4.7225,16.42 6.3625,18 11.5025,18 C16.6425,18 18.2825,16.42 18.3625,16.36 C18.4825,16.24 18.5225,16.06 18.4825,15.9 L18.2625,14.88 Z"
                                        id="W"></path>
                ...
                <div class="icon sort">
                    <div class="hover sort">
                        <ul>
                            ...
                            <li><a href="#">
                                    ...
                                    <div class="text">Sort by Assigned</div>
                                </a>
                            </li>
                            <li><a href="#">
                                    <div class="icon">
                                    ...
                                    <div class="text">Sort by Priority</div>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="top">
                        <svg class="sort-az" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-disabled="false">
                            <g stroke="none" stroke-width="1" fill-rule="evenodd">
                                <g id="sort-az">
                                    <path d="M14.2,2.3 C14.12,2.12 13.94,2 13.76,2 L13.26,2 C13.06,2 12.88,2.12 12.8,2.3 L10.04,8.3 C9.94,8.54 10.04,8.84 10.3,8.96 C10.54,9.08 10.84,8.96 10.96,8.7 L11.74,7 L15.26,7 L16.04,8.7 C16.14,8.9 16.32,9 16.5,9 C16.58,9 16.64,8.98 16.7,8.96 C16.96,8.84 17.06,8.54 16.96,8.3 L14.2,2.3 Z M5.64,3.02 C5.56,3 5.48,3 5.4,3 C5.3,3.02 5.22,3.08 5.14,3.16 L3.14,5.14 C2.96,5.34 2.96,5.66 3.14,5.86 C3.34,6.04 3.66,6.04 3.86,5.86 L5,4.7 L5,8.5 C5,8.78 5.22,9 5.5,9 C5.78,9 6,8.78 6,8.5 L6,4.7 L7.14,5.86 C7.24,5.96 7.38,6 7.5,6 C7.62,6 7.76,5.96 7.86,5.86 C8.04,5.66 8.04,5.34 7.86,5.14 C5.68,2.98 5.8,3.08 5.64,3.02 L5.64,3.02 Z M14.8,6 L12.2,6 L13.5,3.16 L14.8,6 Z M6,15.3 L6,11.5 C6,11.22 5.78,11 5.5,11 C5.22,11 5,11.22 5,11.5 L5,15.3 L3.86,14.14 C3.66,13.96 3.34,13.96 3.14,14.14 C2.96,14.34 2.96,14.66 3.14,14.86 C5.28,17 5.2,16.96 5.4,17 C5.56,17.02 5.74,16.98 5.86,16.84 L7.86,14.86 C8.04,14.66 8.04,14.34 7.86,14.14 C7.66,13.96 7.34,13.96 7.14,14.14 L6,15.3 Z M15.94,11.26 C15.86,11.1 15.68,11 15.5,11 L11.5,11 C11.22,11 11,11.22 11,11.5 C11,11.78 11.22,12 11.5,12 L14.56,12 L11.08,17.22 C10.98,17.38 10.98,17.58 11.06,17.74 C11.14,17.9 11.32,18 11.5,18 L15.5,18 C15.78,18 16,17.78 16,17.5 C16,17.22 15.78,17 15.5,17 L12.44,17 L15.92,11.78 C16.02,11.62 16.02,11.42 15.94,11.26 L15.94,11.26 Z"
                                        id="sort"></path>
                ...
                <div class="icon more">
                    ...
                    <div class="hover more">
                        <ul>
                            <li><a href="#">
                                    ...
                                    <div class="text">Duplicate List</div>
                                </a>
                            </li>
                            <li><a href="#">
                                    <div class="icon">
                            ...
                            <li><a href="#">
                                    ...
                                    <div class="text">Email Seclect To-Do</div>
                                </a>
                            </li>
                            <li><a href="#">
                                    <div class="icon">
                            ...
                            <li><a href="#">
                                    ...
                                    <div class="text">Delete Select To-Do</div>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="top">
                        <svg class="folder-option" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
                            <g id="Layer 1">
        ...
        <div class="task-scroll" id="style-2">
            ...
            //                 }
            //                 $sql2 = "SELECT * from task where listId = '$listId' and title like '%$search%'";
            ...
            //                         </div>
            //                         <div class="text">
            //                             <div class="text-1">'.$task['title'].'</div>
            //                         </div>
            //                         <div class="icon-2">
            ...
            <!-- <div class="task-list search">
                ...
                <ol class = "tasks">
                    <li class="task-item">
                            ...
                            <div class="text">
                                <div class="text-1">Barcelona</div>
                            </div>
                            <div class="icon-2">
                                <svg width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve">
            ...
            <div class="addTask">
                <div class="icon">
                    ...
                    <input name="addTask" type="text" placeholder="Add a to-do..."/>
            ...
            <div class="task-list">
                ...
                <ol class="task-1 clone">
                
                </ol>

                <div class="tieu-de">Show complete to-dos</div>
                <?php
                ...
                <ol class="task-2">
                    ...
                    <!-- <li class="task-item">
                        ...
                        <div class="text">
                            <div class="text-1">Barcelona</div>
                            <div class="text-2">a few second ago</div>
                        </div>
                        <div class="icon-2">
                            <svg width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve">
    ...
    <div id="main-right">
        <div class="top-right">
            ...
            <div class="display-view">
                ...
                <input class="display-view_input" type="text" name = 'nameTask' value="">
           
            </div>
            <div class="icon-2">
                <svg width="22px" height="49px" viewBox="0 0 22 49" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="mid-right" id="style-1">
            ...
            <div class="line-1 subtask">
              ...
              <div class="line">
                ...
                <input class='addSubtask' name='addSubtask'  type="text" placeholder="Add a subtask">
                <input class = 'input_taskId' type="text" value>
              </div>
              
            </div>
            <div class="line-1">
                <div class="icon-1">
                    <svg class="options rtl-flip" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g stroke="none" stroke-width="1" fill-rule="evenodd">
                            <g id="options">
                                <path d="M17.1330617,2.8594383 C15.9930617,1.7194383 14.0130617,1.7194383 12.8930617,2.8594383 L5.5130617,10.2394383 C5.3330617,10.4394383 5.3330617,10.7594383 5.5130617,10.9594383 C5.7130617,11.1394383 6.0330617,11.1394383 6.2330617,10.9594383 L13.5930617,3.5594383 C14.3530617,2.7994383 15.6730617,2.7994383 16.4130617,3.5594383 C17.1730617,4.3194383 17.1930617,5.5594383 16.4130617,6.3394383 L9.0330617,13.7594383 C8.7130617,14.0794383 8.9330617,14.6194383 9.3730617,14.6194383 C9.5130617,14.6194383 9.6330617,14.5594383 9.7330617,14.4594383 L17.1330617,7.0394383 C18.2930617,5.8794383 18.2930617,4.0194383 17.1330617,2.8594383 L17.1330617,2.8594383 Z M8.4930617,15.3594383 C8.0330617,13.4594383 6.5130617,11.9394383 4.6130617,11.4794383 C4.3530617,11.4194383 4.0930617,11.5794383 4.0130617,11.8194383 L2.0330617,17.3194383 C1.8730617,17.7194383 2.2730617,18.1194383 2.6730617,17.9594383 C8.6730617,15.7794383 8.2530617,15.9594383 8.3730617,15.8194383 C8.4930617,15.6994383 8.5330617,15.5194383 8.4930617,15.3594383 L8.4930617,15.3594383 Z M3.3330617,16.6594383 L4.8130617,12.5794383 C6.0130617,12.9994383 6.9730617,13.9794383 7.3930617,15.1794383 L3.3330617,16.6594383 Z"
                ...
                <div class="icon-2"><svg class="fullscreen" width="20px" height="20px" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20"
                        enable-background="new 0 0 20 20" xml:space="preserve">
                        <g>
                            <path d="M12.5,10c-0.276,0-0.5,0.224-0.5,0.5v3c0,0.275-0.225,0.5-0.5,0.5h-6C5.224,14,5,13.775,5,13.5v-6 C5,7.224,5.224,7,5.5,7h3C8.776,7,9,6.776,9,6.5S8.776,6,8.5,6h-3C4.673,6,4,6.673,4,7.5v6C4,14.327,4.673,15,5.5,15h6 c0.827,0,1.5-0.673,1.5-1.5v-3C13,10.224,12.776,10,12.5,10z"></path>
                            <path d="M14.962,4.309c-0.051-0.122-0.148-0.22-0.271-0.271C14.63,4.013,14.565,4,14.5,4h-4 C10.224,4,10,4.224,10,4.5S10.224,5,10.5,5h2.793l-5.146,5.146c-0.195,0.195-0.195,0.512,0,0.707C8.244,10.951,8.372,11,8.5,11 s0.256-0.049,0.354-0.146L14,5.707V8.5C14,8.776,14.224,9,14.5,9S15,8.776,15,8.5v-4C15,4.435,14.987,4.37,14.962,4.309z"></path>
                        </g>
                    </svg></div>
            </div>
            <div class="line-1">
                <div class="icon-1">
                    <svg class="clip" width="20" height="20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20"
                        enable-background="new 0 0 20 20" xml:space="preserve">
                        <g>
                            <path id="XMLID_2_" d="M7,17c-1.335,0-2.591-0.521-3.536-1.465S2,13.336,2,12c0-1.335,0.52-2.591,1.464-3.536l5.312-5.312 c0.195-0.195,0.512-0.195,0.707,0s0.195,0.512,0,0.707L4.171,9.171C3.416,9.927,3,10.932,3,12s0.416,2.073,1.171,2.828 c1.511,1.512,4.146,1.512,5.657,0l6.441-6.441c0.473-0.472,0.732-1.1,0.732-1.768c0-0.668-0.26-1.296-0.732-1.768 c-0.945-0.945-2.592-0.943-3.535,0l-6.441,6.441c-0.39,0.39-0.39,1.024,0,1.414c0.378,0.377,1.036,0.377,1.414,0l4.562-4.562 c0.195-0.195,0.512-0.195,0.707,0s0.195,0.512,0,0.707l-4.562,4.562c-0.755,0.756-2.073,0.756-2.828,0 c-0.78-0.779-0.78-2.049,0-2.828l6.441-6.441c1.32-1.321,3.627-1.323,4.949,0c0.661,0.661,1.025,1.54,1.025,2.475 s-0.364,1.814-1.025,2.475l-6.441,6.441C9.591,16.479,8.335,17,7,17z"></path>
                        </g>
                    </svg>
                </div>
                <div class="text add-a-file">Add a file</div>
                <div class="icon-2">
                    <svg class="speech" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g stroke="none" stroke-width="1" fill-rule="evenodd">
                            <g id="speech">
                                <path d="M10,13 C11.92,13 13.5,11.42 13.5,9.5 L13.5,5.5 C13.5,3.58 11.92,2 10,2 C8.08,2 6.5,3.58 6.5,5.5 L6.5,9.5 C6.5,11.42 8.08,13 10,13 L10,13 Z M7.5,5.5 C7.5,4.12 8.62,3 10,3 C11.38,3 12.5,4.12 12.5,5.5 L12.5,9.5 C12.5,10.88 11.38,12 10,12 C8.62,12 7.5,10.88 7.5,9.5 L7.5,5.5 Z M15.5,8.5 C15.5,8.22 15.28,8 15,8 C14.72,8 14.5,8.22 14.5,8.5 L14.5,9.5 C14.5,11.98 12.48,14 10,14 C7.52,14 5.5,11.98 5.5,9.5 L5.5,8.5 C5.5,8.22 5.28,8 5,8 C4.72,8 4.5,8.22 4.5,8.5 L4.5,9.5 C4.5,12.36 6.7,14.72 9.5,14.98 L9.5,17 L6,17 C5.72,17 5.5,17.22 5.5,17.5 C5.5,17.78 5.72,18 6,18 L14,18 C14.28,18 14.5,17.78 14.5,17.5 C14.5,17.22 14.28,17 14,17 L10.5,17 L10.5,14.98 C13.3,14.72 15.5,12.36 15.5,9.5 L15.5,8.5 Z"
                                    id="O"></path>
                            </g>
                        </g>
                    </svg>
                ...
                <div class="icon-2">
                    <svg class="dropbox" width="20" height="20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20"
                        enable-background="new 0 0 20 20" xml:space="preserve">
                        <g>
                            <polygon points="6.515,2.227 1.535,5.478 4.979,8.236 10,5.135 "></polygon>
                            <polygon points="1.535,10.994 6.515,14.245 10,11.336 4.979,8.236 "></polygon>
                            <polygon points="10,11.336 13.485,14.245 18.465,10.994 15.021,8.236 "></polygon>
                            <polygon points="18.465,5.478 13.485,2.227 10,5.135 15.021,8.236 "></polygon>
                            <polygon points="10.01,11.962 6.515,14.862 5.02,13.886 5.02,14.981 10.01,17.973 15.001,14.981 15.001,13.886 13.505,14.862"></polygon>
                        </g>
                    </svg>
                </div>
            </div>
            <ul class="comment-list">
                ...
                //         </div>
                //         <div class="delete">
                //         <a href="deleteComment.php?cmtId='.$cmtId.'">
        ...
        <div class="bottom-right">
            ...
            <div class="comments">
                <div class="input-fake">
                    ...
                    <input class="addComment" name="addComment" type="text" placeholder="Add a comment...">
            
                </div>

            </div>

            <div class="text">Create on wed,July 31</div>
