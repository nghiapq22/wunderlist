...
<body>
    <div class="header">
        <div class="header-text">
          This site uses cookies for analytics, personalized content and ads. By c
          
          ontinuing to browse this site, you agree to this use.
    ...
    <div class="login-form">
        <form class="loginTab signup" action="xulySignUp.php" method="POST">
