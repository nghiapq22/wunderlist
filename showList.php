<?php
                    ...
                    $sql = "SELECT list.* FROM user_list
                    ...
                    foreach ($data as $row) {
                        ...
                        <span class="icon">
                        <svg class="list rtl-flip" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span class="title" >'.$title.'</span><span class="listId" >'.$listId.'</span>
